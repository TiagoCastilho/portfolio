            ...
            <div className="project-body">
                ...
                <div className="right-side">
                    ...
                    <div className='button-area'>
                        <a href="https://tiagocastilho.github.io/Estudo---ReactJS/react-ex02/build/index.html"  target="_blank" rel="noopener noreferrer" className="project-button">Testar Projeto</a>
