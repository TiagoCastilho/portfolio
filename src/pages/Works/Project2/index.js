        ...
        <div className="projectWindowArea">
            <div className="projectWindowBody">
                ...
                <div className="projectInfo">
                    ...
                    <a href="https://tiagocastilho.github.io/Estudo---ReactJS/react-ex02/build/index.html"  target="_blank" rel="noopener noreferrer" className="projectInfo--testButton">Testar Projeto</a>
